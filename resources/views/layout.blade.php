...
<body class=""> <button id="accessibility-btn" 
    ...
    <div class="pipboy-case" style="background-image: url('{{ asset($bg) }}');">
        ...
        <nav class="nav-menu" aria-label="Główna nawigacja Pip-Boya">
            <a href="{{ route('stats') }}" class="pip-knob" title="Stats" aria-label="Statystyki"
               style="width: 50px; height: 50px; top: 78.5%; left: 47%;"></a>

            <a href="{{ route('items') }}" class="pip-knob" title="Items" aria-label="Przedmioty"
               style="width: 50px; height: 50px; top: 78.5%; left: 53.5%;"></a>

            <a href="{{ route('data') }}" class="pip-knob" title="Data" aria-label="Dane i Zadania"
